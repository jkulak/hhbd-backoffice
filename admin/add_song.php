...
include ('include/functions.php');
  ...
  function goback(){ 
   ...
   "feat1id=$_GET[feat1id]&feat2id=$_GET[feat2id]&feat3id=$_GET[feat3id]&feat4id=$_GET[feat4id]&" .
   "feat1=$_GET[feat1]&feat2=$_GET[feat2]&feat3=$_GET[feat3]&feat4=$_GET[feat4]&" .
   "music1id=$_GET[music1id]&music2id=$_GET[music2id]&scratch1id=$_GET[scratch1id]&scratch2id=$_GET[scratch2id]&" .
   "music1=$_GET[music1]&music2=$_GET[music2]&scratch1=$_GET[scratch1]&scratch2=$_GET[scratch2]&" .   
   "bpm=$_GET[bpm]&track=$_GET[track]&length=$_GET[length]&albumid=$_GET[albumid]&" .
   "title=$_GET[title]&artist2=$_GET[artist2]&artistid2=$_GET[artist_list2]&artist3=$_GET[artist3]&artistid3=$_GET[artist_list3]&" .
   "artist4=$_GET[artist4]&artistid4=$_GET[artist_list4]&addedby=$_GET[addedby]&remix1id=$_GET[remix1id]&remix=$_GET[remix]&" . 
   "acapella=$_GET[acapella]&radio=$_GET[radio]&instrumental=$_GET[instrumental]" . 
   "\">Popraw</a>");
   } 
...
// ARTIST 4
 ...
 // dodajemy ewentualnie remix artist	
  ...
  $oldsongid = $_GET['oldsong'];
  
  if ($oldsongid == '') {
  
  
  
 $newname = create_urlname($_GET['title'], 1, 1);
	$basename = $newname;
  ...
  print ("<a href=\"add_song_form.php?addedby=$_GET[addedby]&artist1id=$artist1id&artist2id=$artist2id&artist3id=$artistid3&track=" . ($_GET[track] + 1) . "&albumid=$albumid\">Dodaj nast�pn�</a><br>");
