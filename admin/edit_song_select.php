...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td> 
      <div align="left"><b><font size="3">WYBIERZ UTW&Oacute;R DO EDYCJI</font></b></div>
    </td>
  </tr>
  <tr>
    <td height="15">&nbsp;</td>
  ...
  <tr>
    <td align="left"> 
      <form action="edit_song_form.php" method="get" name="add_album" target="_self" enctype="multipart/form-data">
  ...
  ?>
          ...
          <tr> 
            <td width="180" height="0" valign="top" align="left"> 
              <input type="submit" value="WYBIERZ UTW&Oacute;R" style="width: 120px">
            </td>
