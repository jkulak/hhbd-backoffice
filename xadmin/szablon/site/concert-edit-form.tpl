...
<form action="?s=edytujkoncert" method="POST" enctype="multipart/form-data">
...
<input id="artists" name="artists" type="text" maxlength="255" value="{$artists}" class="maxlen"><BR>
...
<textarea name="description" rows="10" class="maxlen">{$description}</textarea><BR>
...
<input type="text" name="date" value="{$date}" class="maxlen"><BR>
data koncertu w formacie rrrr-mm-dd
</div>

<div class="rbox"><strong>START</strong><BR>
<input type="text" name="start" value="{$start}" class="maxlen"><BR>
...
<input type="text" name="cost" value="{$cost}" class="maxlen"><BR>
...
<input type="text" name="place" value="{$place}" class="maxlen"><BR>
...
<input type="text" name="website" value="{$website}" class="maxlen"><BR>
...
<input type="submit" name="action" value="ZAPISZ" class="btn" style="float: right; display: inline; width: 200px; color: green;">
<input type="submit" name="action" value="SKASUJ" class="btn" style="float: left; display: inline; color: red; width: 200px;">
